...
<!--menu-->
    ...
    <div id="sub">
        ...
        <label for=""><h2>To enroll yourself for Tanishq's Mail newsletter Enter</h2></label><br><br><br><br>
        <label for=""><h4>Email Id</h4></label>
            <input type="email" name="email_id" placeholder="Enter your Email Id" maxlength="250" autofocus required><br><br><br><br>
            <button type="submit" class="btn btn-light">Submit</button><br>
        </from>
    </div>
    ...
    <?php
        if($_SERVER['REQUEST_METHOD'] == 'POST')
        {
            ...
            {
                $query = "INSERT INTO subscribers (email_id) VALUES('$email')";
                $result = mysqli_query($conn, $query);
                if($result)
                {
                    echo "<br><h3><center>You are now Subscribed to Tanishq's Mail newsletter Enter</center></h3>";
                }
                else
                {
